			...
			<div class="col-lg-6" style="margin: 0 auto;">
				<div class="card">
					...
					<div class="card-body card-block">
						<form action="${path}/board/updateBoard.do" method="post"
							class="form-horizontal" name="writeForm" id="writeForm">
							<input name="bno" style="display: none;" value="${map.dto.bno}" />
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="place" name="place"
										placeholder="장소를 입력해 주세요." class="form-control"
										value="${map.dto.place}">
								</div>
							</div>
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<input type="datetime-local" id="calendar" name="calendar"
										class="form-control"
										value=<fmt:formatDate value="${map.dto.calendar}" pattern="yyyy-MM-dd'T'hh:mm"/>>
								</div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3">
								...
								<div class="col-12 col-md-9">
									<textarea name="content" id="content" rows="9"
										placeholder="내용을 입력해 주세요." class="form-control">${map.dto.content}</textarea>
								</div>
							</div>
						</form>
						<div class="card-footer">
							<button type="submit" class="btn btn-primary btn-sm"
								id="insertBtn" onclick="update()">
								<i class="fa fa-dot-circle-o"></i> 수정
							</button>
							<button type="reset" class="btn btn-danger btn-sm" id="backBtn"
								onclick="gobackFun()">
