...
<body class="text-center" style="align-content: center">
	<main class="form-signin" style="width: 430px; align-content: center;">
		...
		<div style="background-color: white; border-radius: 15px; border: 1px solid #43bc9c;">
			<br>
			<h6 style="color: #7c7c7c;">아이디 찾기 검색결과</h6><br>
			<div>
				<h4>
				
				당신의 ID는 <span style="font-weight: bold; color: #43bc9c;">&nbsp;${ userid }&nbsp;</span>입니다.
				</h4> <br>
			</div>
		</div>
		...
		<button class="btn btn-lg btn-primary" type="button" id="findPwBtn"
				style="background-color: #43bc9c; border-color: #43bc9c; display: inline-block; width: 49%">비밀번호 찾기</button>
