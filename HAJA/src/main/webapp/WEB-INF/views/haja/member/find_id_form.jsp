...
<body class="text-center" style="align-content: center">
	<main class="form-signin" style="width: 430px; align-content: center;">
		<form name="form1" method="post" style="width: 400px" action="${path}/member/find_id.do">
			<a href="${path}/member/home.do">
				<img alt="상단배너" src="../resources/assets/brand/haja-logo.jpg" width="72px" height="72">
			</a> 
			<p>
			<h1 class="h3 mb-3 fw-normal">아이디 찾기</h1> <br> <br>
			...
			<div style="width: 400px;" align="left">
				...
				<div class="form-floating" align="center">
					<input class="form-control" id="email" name="email" placeholder="Email" style="align-content: center" required>
			...
			<button class="btn btn-lg btn-primary" type="submit" id="findBtn"
				style="background-color: #43bc9c; border-color: #43bc9c; display: inline-block; width: 49%">ID 조회</button> 
