	...
	<div class="section__content section__content--p30">
		<div class="container-fluid">
			<div class="header-wrap">
				...
				<form class="form-header" name="searchForm" action="" method="POST">
					</select> 
					<input  class="au-input au-input--xl" type="text" name="keyword" placeholder="${placeholder}">
					<button class="au-btn--submit" type="submit" style="background-color: #43bc9c;">
					...
					<c:when test="${sessionScope.userid == null}">
						...
						<div class="header-button">
							<div class="noti__item">
								<a href="${path}/member/login.do"> <i
									class="zmdi zmdi-account"></i>
								</a>
							</div>
							<div class="noti__item">
								<a href="${path}/member/join.do"> <i
